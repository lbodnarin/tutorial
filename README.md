...
This tutorial explains how to run an extract, transform, and load (ETL) workload on your local machine.
...
Here is my [GitHub repo](https://github.com/lbodnarin/tutorial.git).
...
```shell
git clone https://github.com/lbodnarin/tutorial.git
```
...
--path ./tutorial/work-dir/DATASET/ \
--unzip
```
...
```shell
echo -e "AIRFLOW_UID=$(id -u)" > ./tutorial/.env
```
...
```shell
docker compose \
--file ./tutorial/docker-compose.yml up \
--detach
```
...
```shell
tutorial/work-dir/OUTPUT/aggregate_data/
├── 2009/
├── ...
└── 2018/
  ├── _delta_log/
...
```shell
tutorial/work-dir/OUTPUT/outlier_detection/
├── 2009/
├── ...
└── 2018/
  ├── _delta_log/
...
```shell
tutorial/work-dir/OUTPUT/plot_data/
├── 2009/
├── ...
└── 2018/
  ├── ...
...
```shell
docker compose \
--file ./tutorial/docker-compose.yml down \
--rmi all
```
